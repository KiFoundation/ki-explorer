...
export default class Proposals extends Component{
    ...
    render() {
        return <div>
            <Helmet>
                <title>Governance Proposals on Ki Chain</title>
                <meta name="description" content="Ki Chain incorporates on-chain governance. Come to see how on-chain governance can be achieved on Ki Chain." />
            </Helmet>
            <Row>
