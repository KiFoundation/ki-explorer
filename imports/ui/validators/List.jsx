...
const ValidatorRow = (props) => {
    ...
    return (
        <SentryBoundary>
            <Row className="validator-info bg-white my-2 py-3 list-border">
                ...
                {(!props.inactive)?<Col className="uptime data" xs={{size:2,order:"last"}} md={2}><Progress variant="val" animated value={props.validator.uptime}><span className="d-none d-md-inline">{props.validator.uptime?props.validator.uptime.toFixed(2):0}%</span><span className="d-md-none">&nbsp;</span></Progress></Col>:''}
