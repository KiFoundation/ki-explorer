                      ...
                      <Card className="mb-0 h-100 normal-shadow">
                        <CardBody>
                          <Row>
                            <Col md={3}>
                                <div className="d-flex">
                                    ...
                                    <div className="ml-3">
                                        ...
                                        <div>
                                            <span className="font-800 dark-color"><T>common.votingPower</T> </span>
                                            <span className="dark-color">{this.props.validator.voting_power?numbro(this.props.validator.voting_power/this.props.chainStatus.activeVotingPower).format('0.00%'):"0.00%"}</span>
                                        </div>
                                        <div>
                                            <span className="font-800 dark-color"><T>validators.commission</T> </span>
                                            <span className="dark-color">{this.props.validator.commission&&this.props.validator.commission.commission_rates?numbro(this.props.validator.commission.commission_rates.rate*100).format('0.0')+"%":''}</span>
                                        </div>
                                        <div>
                            ...
                            <Col md={3}>
                                  <div className="d-block mb-2 d-flex justify-content-between">
                                      <span className="font-500"><T>validators.total</T></span>
                                      <div >{numbro(this.props.validator.voting_power).format('0,0')} {Meteor.settings.public.stakingDenom}</div>
                                  </div>
                                        <div className="d-flex">
